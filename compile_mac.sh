...
clang++ -std=c++11 -w -DEIGEN_USE_MKL_ALL -dynamiclib -std=c++11  -L${MKLROOT}/lib -lmkl_intel_lp64 -lmkl_core -lmkl_intel_thread -liomp5 -lpthread -lm -ldl -m64 -I${MKLROOT}/include -I. -Ofast -DNDEBUG source/model.cpp -o lib/libmodel.dylib
...
echo "libmodel.dylib compiled!"
clang++ -std=c++11 -w -Llib/ -lmodel -Iinclude -I. -Ofast -DNDEBUG source/mLearn.cpp -o mLearn
